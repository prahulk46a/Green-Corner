...
const Hero = () => {
  ...
  return (
    <div className="grid  place-items-center">
      <section className="relative grid place-items-center w-full px-2 pb-2">
        {/* Fullscreen Background Image */}
        <img
          src="https://www.pickmyflowers.com/assets/imgs/new/nurserylive-home-page-banner.webp"
          alt="Hero Plants"
          className="relative w-full rounded-md shadow-xl m-2 -z-10"
        />
      ...
      <div className="w-[98%] py-5 rounded-full md:text-2xl sm:text-lg text-green-700 font-bold grid place-items-center shadow-sm bg-slate-100 overflow-x-hidden">
